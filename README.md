...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/lakepy-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14174&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/lakepy-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `lakepy` can be installed with:

```
conda install lakepy
```

It is possible to list all of the versions of `lakepy` available on your platform with:
